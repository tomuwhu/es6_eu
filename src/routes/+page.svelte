...
<div class="container text-center">
			...
			<a class="btn btn-outline-primary btn-sm" href="sob" target="_blank">Szakképzési statikus oldal</a>
			<a class="btn btn-outline-danger btn-sm" href="https://sobes.netlify.app/" target="_blank">Új Szakképzési FullStack oldal</a>
			<h4>2023/24</h4>
...
<style>
	...
	img:hover {
		box-shadow: 1px 1px 6px rgb(30, 15, 15);
		border: solid 2px black;
	}
	img:active {
		box-shadow: 1px 1px 1px rgb(30, 15, 15);
		border: solid 2px black;
	}
</style>
